...
{
    public $uploadCustomfield = 'customfield/product';
    public $uploadCustomfieldGallery = 'customfield/product';
    /**
     *
     */
    ...
    public function rules()
    {
        return [
            [
                'name, title, description, short_description, slug, price, discount_price, discount, data, status, is_special, times, units, text_bold',
                'filter',
                'filter' => 'trim',
            ],
            [
            ...
            ['meta_canonical', 'url'],
            [
                'id, type_id, producer_id, sku, name, slug, price, discount_price, discount, short_description, description, data, is_special, length, height, width, weight, quantity, in_stock, status, create_time, update_time, meta_title, meta_description, meta_keywords, category_id, times, units, docs, text_bold',
                'safe',
                'on' => 'search',
            ],
        ];
    ...
    public function attributeLabels()
    {
        return [
            ...
            'times' => Yii::t('StoreModule.store', 'Срок'),
            'units' => Yii::t('StoreModule.store', 'Единицы измерения'),
            'docs' => Yii::t('StoreModule.store', 'Прайс-лист'),
            'text_bold' => Yii::t('StoreModule.store', 'Выделенный текст'),
        ];
    }
    ...
    public function search()
    {
        ...
        $criteria->compare('t.times', $this->times);
        $criteria->compare('t.units', $this->units);
        $criteria->compare('t.docs', $this->docs);
        $criteria->compare('t.text_bold', $this->text_bold);
    ...
    public function beforeSave()
    {
        ...
        if(!empty($myfield)){
            ...
            $this->field = serialize($newmyfield);
    ...
    {
        $module = Yii::app()->getModule('store');
        return '/uploads/'.$module->uploadPathPrice.'/'.$this->docs;
    }
    ...
    */
    public function getAttributeValue($code)
    {
        ...
        return (!empty($field[$code])) ? $field[$code] : false;
    }
