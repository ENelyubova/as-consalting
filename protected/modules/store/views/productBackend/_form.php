...
<ul class="nav nav-tabs">
    ...
    <li><a href="#setting" data-toggle="tab"><?= Yii::t("StoreModule.page", "Произвольные поля"); ?></a></li>
</ul>
...
<div class="tab-content">
    <div class="tab-pane active" id="common">
        ...
        <div class="row">
            <div class="col-sm-1">
                <?= $form->textFieldGroup($model, 'times'); ?>
            </div>
            <div class="col-sm-2">
        ...
        <div class='row'>
            <div class="col-sm-12 <?= $model->hasErrors('text_bold') ? 'has-error' : ''; ?>">
                <?= $form->labelEx($model, 'text_bold'); ?>
                <?php $this->widget(
                    $this->module->getVisualEditor(),
                    [
                        'model' => $model,
