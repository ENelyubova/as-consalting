...
<div class="row form-group">
    <div class="col-sm-6">
        ...
        <input type="hidden" id="MyCustomFieldDelete" name="MyCustomFieldDelete" class=" form-control"/>
    </div>
</div>
<div class="row js-myfield-row" data-key="<?= (!empty($model->field) ? count($model->field) : 0); ?>">
    <div class="col-xs-12">
        ...
        <?php if ($model->field): ?>
            <div class="panel-group">
                <div class="panel panel-default" style="border: none;background-color: transparent;">
                    <?php foreach ($model->field as $key=>$field): ?>
                        <div class="js-myfield" data-id="<?= $model->id; ?>" data-key="<?= $key; ?>">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-5">
                                                <label for="">Название</label>
                                                <?= CHtml::textField('MyCustomField['.$key.'][name]', $field['name'],
                                                    ['class' => 'form-control']) ?>
                                            </div>
                                            <div class="col-sm-3">
                                                <label for="">Code</label>
                                                <?= CHtml::textField('MyCustomField['.$key.'][code]', $field['code'], [
                                            ...
                                            <div class="col-sm-3">
                                                <label for="">Выберите редактор</label>
                                                <?= CHtml::dropDownList('MyCustomField['.$key.'][template]', $field['template'], [
                                                        'CodeMirror' => 'Обычное поле',
                                                        'Redactor' => 'Редактор',
                                                    ],
                                                    [
                                            ...
                                            <div class="col-xs-11 col-sm-11">
                                                <label for="">Значение</label>
                                                <div class="js-template-field">
                                                    <?php if($field['template'] == 'Redactor') : ?>
                                                        <?php $this->widget( $this->yupe->getVisualEditor(),[
                                                            'name' => 'MyCustomField['.$key.'][value]',
                                                            'value' => $field['value']                                                  
                                                        ]); ?>
                                                    <?php else : ?>
                                                        <?= CHtml::textArea('MyCustomField['.$key.'][value]', $field['value'], [
                                        ...
                                        <div class='row'>
                                            <div class="col-sm-4">
                                                <label for="">Название кнопки</label>
                                                <?= CHtml::textField('MyCustomField['.$key.'][butName]', $field['butName'],
                                                    ['class' => 'form-control']) ?>
                                            </div>
                                            <div class="col-sm-4">
                                                <label for="">Ссылка на кнопку</label>
                                                <?= CHtml::textField('MyCustomField['.$key.'][butLink]', $field['butLink'],
                                                    ['class' => 'form-control']) ?>
                                            </div>
                                        </div>
                                        <div class='row'>
                                            <div class="col-sm-12">
                                                <div class="col-sm-8">
                                                    ...
                                                    <?php if(!empty($field['image'])) : ?>
                                                        <?= CHtml::hiddenField('MyCustomField['.$key.'][image]', $field['image']) ?>
                                                        <?php
                                                        echo CHtml::image($model->getFieldImageUrl(200,200,false,$field['image']),
                                                            '',
                                                            [
                                                                'class' => 'preview-image',
                                                            ]
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <?php if(!empty($field['gallery'])) : ?>
                                                        <div id="galleryField-wrapper">
                                                            ...
                                                            <?php foreach ($field['gallery'] as $key2 => $images) :?>
...
<script type="text/javascript">
    ...
    */
    $(document).delegate('#button-add-myfield', 'click', function () {
        ...
        newfield.find(".myfield-delete").attr('name', 'MyCustomField[' + key + '][delete]');
...
   
    ...
    */
    $('.button-delete-myfield').on('click', function () {
        // var id = $(this).parents('.js-myfield').data('id');
        var id = $(this).parents('.js-myfield').data('key');
        ...
        /*if(key === 0){
            ...
            $.ajax({
                ...
                url: '<?= Yii::app()->createUrl('/store/productBackend/removeField');?>',
            })
        }*/
        return false;
    });
