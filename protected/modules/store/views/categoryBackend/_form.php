...
<ul class="nav nav-tabs">
    ...
    <li><a href="#setting" data-toggle="tab"><?= Yii::t("StoreModule.store", "Произвольные поля"); ?></a></li>
</ul>
...
<div class="tab-content">
    <div class="tab-pane active" id="common">
        ...
        <div class='row'>
            <div class="col-sm-7">
                <?= (!$model->isNewRecord && $model->price) ? $model->price : ''; ?>
                <?php if (!$model->isNewRecord && $model->price): ?>
                    <div class="checkbox">
                        <label>
                ...
                <?= $form->fileFieldGroup($model, 'price'); ?>
