...
class Page extends yupe\models\YModel
{
    ...
    public function rules()
    {
        return [
            ...
            ['meta_title, meta_keywords, meta_description, layout, view', 'length', 'max' => 250],
            ...
            [
                'lang, id, parent_id, create_time, update_time, title, title_short, slug, body, body_short, meta_title, meta_keywords, meta_description, status, order, lang, document, price',
                'safe',
                'on' => 'search',
            ],
        ];
    ...
    public function attributeLabels()
    {
        return [
            ...
            'image' => Yii::t('PageModule.page', 'Фото'),
