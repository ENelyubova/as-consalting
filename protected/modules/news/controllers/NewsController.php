...
class NewsController extends \yupe\components\controllers\FrontController
{
    ...
    public function actionIndex()
    {
        ...
        if(isset($_GET['customMounthly']) && $_GET['customMounthly'] != ''){
            $dbCriteria->compare('month(date)', $_GET['customMounthly']);
        }
        if(isset($_GET['customYear']) && $_GET['customYear'] != ''){
            $dbCriteria->compare('year(date)', $_GET['customYear']);
        }
        if(isset($_GET['customCategory']) && $_GET['customCategory'] != ''){
            $dbCriteria->compare('category_id', $_GET['customCategory']);
        }
